...
/**
 * <p>Clase Java para PayPalPreapprovedPaymentService complex type.
 * 
...
@XmlType(name = "PayPalPreapprovedPaymentService", propOrder = {
    "mpID",
    "reconciliationID"
})
public class PayPalPreapprovedPaymentService {
    ...
    /**
     * Obtiene el valor de la propiedad mpID.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Define el valor de la propiedad mpID.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
